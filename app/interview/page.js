  ...
  async function skip() {
      ...
      const q = questions[index];
        const skippedAnswer = {
                ...
                question: q.text,
                category: q.cat,
                transcript: "(Frage übersprungen)",
                score: 0,
                gut: null,
                nicht_gut: "Diese Frage wurde übersprungen und zählt daher mit 0 Punkten in die Auswertung.",
                verbesserung: "Versuche beim nächsten Mal auch auf diese Frage eine kurze Antwort zu geben — das ist besser als sie zu überspringen.",
                beispiel: null,
        };
